  ...
  return requestQueue.add(async () => {
    ...
    if (errorMsg.includes('quota') || errorMsg.includes('RESOURCE_EXHAUSTED')) {
      ...
      throw new Error(
        ...
        '[!][!][!][!][!][!] Semua model Gemini mencapai quota limit.\n\n' +
...
async function executeGenerateLearningGoals(
  ...
  const lengthConstraint = maxLength100 
    ...
    ? `\n\n[!][!][!][!][!][!] BATASAN PANJANG WAJIB (TOGGLE AKTIF - FORMAT RAPOR):\n[!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!][!]
...
1. [!][!][!][!][!][!] SEMUA TP HARUS MASUK KE SEMESTER 1 SAJA - JANGAN pisahkan ke Semester 2

2. [!][!][!][!][!][!] BUAT TP SEBANYAK YANG DIPERLUKAN UNTUK COVER SEMUA TOPIK UTAMA
...
3. Gunakan 3-KERANJANG METHODOLOGY:
   ...
   [!][!][!][!][!][!] TIDAK BOLEH buat TP untuk detail micro (contoh: "menyebutkan perasaan Kiki", "menjawab pertanyaan spesifik tentang Mimi")

   [!][!][!][!][!][!] HARUS fokus pada BIG PICTURE pembelajaran yang penting
...
1. [!][!][!][!][!][!] SEMUA TP HARUS MASUK KE SEMESTER 2 SAJA - JANGAN pisahkan ke Semester 1
...
3. Gunakan 3-KERANJANG METHODOLOGY:
   ...
   [!][!][!][!][!][!] JIKA ADA UNSUR KEBAHASAAN [!][!][!] SELALU JADI TP #1, BUKAN NOMOR TERAKHIR!
...
1. [!][!][!][!][!][!] PISAHKAN TP ke SEMESTER 1 dan SEMESTER 2 secara SEIMBANG (50:50 jika memungkinkan)

   - Semester 1: Topik dasar/fondasi (Basic & Intermediate)

   - Semester 2: Topik lanjutan/aplikasi (Advanced & Integration)

2. [!][!][!][!][!][!] BUAT TP SEBANYAK YANG DIPERLUKAN PER SEMESTER
...
[!][!][!][!][!][!] CRITICAL: Sebelum output JSON, WAJIB lakukan internal reasoning step-by-step:
...
[!][!][!][!][!][!] INGAT: Output HANYA JSON valid tanpa markdown, tanpa penjelasan.
...
`;
  ...
  return executeWithContextAwareRetry(async (strategy: RetryStrategy, attemptNumber: number) => {
    ...
    try {
      ...
      const normalizationResult = normalizeTPOutput(parsed, gradeLevel, { 
        maxLength: maxLength100 ? 100 : undefined,
        autoFix: true 
      });
...
{"semester1": [], "semester2": [...]}  [!][!][!] Semester 1 KOSONG!`;
            ...
            retryPrompt = `${prompt}\n\n[!][!][!][!][!][!] STRUCTURE ERROR - Setiap chapter HARUS memiliki:
...
4. Setiap chapter punya array tps dengan string TP`;
          ...
          if (semesterSelection === 'semester1') {
            ...
            if ((validateSem1.valid && retryParsed.semester1?.length > 0) || (validateSem2.valid && retryParsed.semester2?.length > 0)) {
              ...
              console.warn('[TP Generation] [!][!][!][!][!][!] Partial success: Returning available semester(s)');
    ...
    for (let i = 0; i < fallbackModels.length; i++) {
      ...
      for (let attempt = 0; attempt < allKeys.length; attempt++) {
        ...
        try {
          ...
          return await executeGenerateQuestions(model, learningGoals, subject, questionConfig);
...
async function executeGenerateQuestions(
  ...
  // Detect Bahasa Daerah subject from both subject name and TP text
  const subjectLower = subject.toLowerCase();
  const isBahasaDaerah = subjectLower.includes('bahasa jawa') || 
                         subjectLower.includes('bahasa daerah') || 
                         subjectLower.includes('basa jawa') ||
                         tpText.includes('bahasa jawa') || 
                         tpText.includes('bahasa daerah') || 
                         tpText.includes('basa jawa') || 
                         tpText.includes('aksara jawa');
  ...
  if (useDistribution && difficultyDistribution) {
    ...
    for (const diff of difficulties) {
      ...
      const subResult = await executeGenerateQuestions(model, learningGoals, subject, subConfig);
    ...
    for (const diff of difficulties) {
      ...
      const isianResult = await executeGenerateQuestions(model, learningGoals, subject, isianConfig);
    ...
    if (difficultyDistribution.uraian) {
      ...
      for (const diff of difficulties) {
        ...
        const uraianResult = await executeGenerateQuestions(model, learningGoals, subject, uraianConfig);
...
` : '';
  ...
  if (questionType === 'uraian' && questionConfig.essay.count > 0) {
    ...
    const bahasaDaerahUraianInstruction = isBahasaDaerah ? `

[!] INSTRUKSI KHUSUS BAHASA DAERAH (BAHASA JAWA):
==================================================
[OK] WAJIB:
1. Gunakan BAHASA JAWA dalam pertanyaan uraian
2. Sesuaikan tingkat bahasa dengan kelas (Ngoko untuk kelas rendah, Krama untuk kelas tinggi)
3. Stimulus boleh berupa cerita rakyat Jawa, geguritan, atau tembang
4. Jawaban yang diharapkan juga dalam Bahasa Jawa
5. Berikan contoh jawaban (modelAnswer) dalam Bahasa Jawa

[NOTE] CONTOH SOAL URAIAN BAHASA JAWA:
Kelas 3-4: "Critakna pengalamanmu nalika sinau basa Jawa ing sekolah! (minimal 3 ukara)"
Kelas 5-6: "Jelasna apa bedane unggah-ungguh basa Jawa ngoko lan krama! Wenehana conto ukarane!"
==================================================
` : '';
...

{
  ...
  "essay": [

    {
      ...
      "relatedTP": "WAJIB diisi dengan TP dari daftar di atas (copy exact text TP)"
...
- [!][!][!][!] WAJIB: Field "relatedTP" HARUS diisi dengan TP yang SESUAI dari daftar di atas

- Setiap soal harus jelas terkait dengan salah satu TP yang diberikan
...
- Scoring rubric harus jelas dan terukur${isBahasaDaerah ? '\n- [!][!][!][!] BAHASA JAWA: Gunakan Bahasa Jawa dalam soal, stimulus, dan jawaban!' : ''}`;
  ...
  const bahasaDaerahInstruction = isBahasaDaerah ? `
...
1. Gunakan BAHASA JAWA dalam soal dan opsi jawaban

2. Sesuaikan tingkat bahasa (Ngoko/Krama) dengan tingkat kelas:

   - Kelas 1-3: Bahasa Jawa Ngoko (bahasa sehari-hari)

   - Kelas 4-6: Boleh campuran Ngoko dan Krama Alus (sopan)

3. Gunakan kosakata Bahasa Jawa yang umum dan mudah dipahami anak

4. Jika ada Aksara Jawa, WAJIB sertakan di imageDescription

5. Pertanyaan bisa bilingual (instruksi Bahasa Indonesia, konten Bahasa Jawa)


[!][!][!][!] CONTOH SOAL BAHASA JAWA YANG BENAR:

Mudah (Kelas 1-2): 

  "Apa jenenge kewan sing iso mabur lan duwe wulu?"
...
Sedang (Kelas 3-4):
  ...
  "Ukara ing ngisor iki sing nganggo basa krama alus yaiku..."

  A. "Aku arep mangan sega"

  B. "Kula badhe dhahar sekul" [!][!][!]
...
Sulit (Kelas 5-6):
  ...
  "Gancarna aksara Jawa iki menyang aksara latin: [gambar aksara jawa]"

  Atau: "Apa bedane tembung 'nggawa' karo 'ngasta' ing basa Jawa?"


[!][!][!] HINDARI:

- Kosakata Jawa kuno/kawi yang terlalu sulit

- Bahasa Krama Inggil untuk kelas rendah

- Istilah sastra Jawa klasik tanpa konteks


[!][!][!][!] TUJUAN: Soal harus mengukur pemahaman siswa terhadap:

- Kosakata Bahasa Jawa sehari-hari

- Unggah-ungguh (tingkat tutur) Bahasa Jawa

- Aksara Jawa (untuk kelas tinggi)
...
2. SEDANG (Medium Level - C3) [!][!][!][!][!][!] PERHATIAN KHUSUS:
...
- [!][!][!][!] WAJIB: Field "relatedTP" HARUS diisi dengan TP yang SESUAI dari daftar di atas (copy exact text, jangan "Tujuan Pembelajaran terkait")
...
- [!][!][!][!][!][!] VALIDASI AKHIR KRITIS: Setiap soal MAKSIMAL ${guide.maxWords} kata dan kosakata sesuai ${gradeLevel}!

- Tambahkan field "wordCount" untuk setiap soal (hitung jumlah kata dalam question)

${isBahasaDaerah ? '- [!][!][!][!] BAHASA JAWA: Pastikan soal dan opsi menggunakan Bahasa Jawa yang sesuai tingkat kelas!' : ''}`;
